defmodule MedicineInventoryWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    #   Gettext.dngettext(MedicineInventoryWeb.Gettext, "errors", msg, msg, count, opts)
    # else
    #   Gettext.dgettext(MedicineInventoryWeb.Gettext, "errors", msg, opts)
    # end
