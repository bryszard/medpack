defmodule MedpackWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    #   Gettext.dngettext(MedpackWeb.Gettext, "errors", msg, msg, count, opts)
    # else
    #   Gettext.dgettext(MedpackWeb.Gettext, "errors", msg, opts)
    # end
    ...
    <div class="navbar bg-base-200 shadow-lg border-b border-base-300">
      ...
      <div class="flex items-center gap-4">
        ...
        <.link navigate={~p"/"} class="flex items-center justify-center">
          <div class="w-16 h-16 bg-success rounded-xl flex items-center justify-center">
            <img src={~p"/images/medpack-logo.png"} alt="Medpack Logo" class="w-16 h-16" />
          </div>
        </.link>
