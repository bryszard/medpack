defmodule MedicineInventory.Application do
  ...
  def start(_type, _args) do
    children = [
      MedicineInventoryWeb.Telemetry,
      ...
      MedicineInventoryWeb.Endpoint
    ]

    # See https://hexdocs.pm/elixir/Supervisor.html
    # for other strategies and supported options
    opts = [strategy: :one_for_one, name: MedicineInventory.Supervisor]
  ...
  def config_change(changed, _new, removed) do
    MedicineInventoryWeb.Endpoint.config_change(changed, removed)
    :ok
  end
